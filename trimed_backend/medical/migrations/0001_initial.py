    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('consultation', models.ForeignKey(db_column='consultation_id', on_delete=django.db.models.deletion.CASCADE, to='medical.consultation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('medicament', models.ForeignKey(db_column='medicament_id', on_delete=django.db.models.deletion.CASCADE, to='gestion_medicaments.medicament')),
                ('ordonnance', models.ForeignKey(db_column='ordonnance_id', on_delete=django.db.models.deletion.CASCADE, to='medical.ordonnance')),
            ],
            options={
